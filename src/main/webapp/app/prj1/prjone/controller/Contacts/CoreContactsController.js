Ext.define('Buzzor.prj1.prjone.controller.Contacts.CoreContactsController',
{
	extend : 'Ext.app.ViewController',
	alias : 'controller.CoreContactsController',
	init:function()
	{
		this.countryIdLoad();
...
if(!(addAddressForm.isValid() || addAddress.store.getCount() != 0)){return;}this.addAddress();var data = this.getViewModel().getData();
